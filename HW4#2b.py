...
####################################################
# Now preforming SVD to get matrix U , S and V
...
###################################################################
#predict the user-based similarity:
...
print 'User based predicted rating: '+str(user_based_predicted_value_with_svd)

###################################################################
#predict the item-based similarity:
...
print 'Item based predicted rating: '+ str(item_based_predicted_with_svd)
